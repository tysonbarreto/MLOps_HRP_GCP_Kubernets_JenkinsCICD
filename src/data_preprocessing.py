...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            raise MLException("Error while preprocess data", e)
    ...
    def balance_data(self,df):
        try:
            ...
            raise MLException("Error while balancing data", e)
    ...
    def select_features(self,df):
        try:
            ...
            raise MLException("Error while feature selection", e)
    ...
    def save_data(self,df , file_path):
        try:
            ...
            raise MLException("Error while saving data", e)
    ...
    def process(self):
        try:
            ...
            raise MLException("Error while data preprocessing pipeline", e)
