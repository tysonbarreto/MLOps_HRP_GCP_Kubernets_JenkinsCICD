...
from utils import read_yaml,load_data
...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            ...
            raise MLException("Failed to load data" ,  e)
    ...
    def train_lgbm(self,X_train,y_train):
        try:
            ...
            raise MLException("Failed to train model" ,  e)
    ...
    def evaluate_model(self , model , X_test , y_test):
        try:
            ...
            raise MLException("Failed to evaluate model" ,  e)
    ...
    def save_model(self,model):
        try:
            ...
            raise MLException("Failed to save model" ,  e)
    ...
    def run(self):
        try:
            ...
            with mlflow.start_run():
                ...
                # log model
                mlflow.sklearn.log_model(best_lgbm_model, artifact_path="model", registered_model_name="best_lgbm_model", signature=signature)
                logger.info("Model Training sucesfullly completed")

        except Exception as e:
            logger.error(f"Error in model training pipeline {e}")
            raise MLException("Failed during model training pipeline" ,  e)
